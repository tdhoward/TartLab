...
class ReleaseAuthenticityTests(unittest.TestCase):
    ...
    def test_legacy_profile_records_published_v015(self):
        ...
        self.assertEqual(profile["hardware_qualification"], {
            ...
            "version": "v0.15",
            "tag_commit": "f7f3223c0de9c32aad3d546efd68c09f73eedbf7",
            "candidate_run_id": 33283338340,
            "candidate_artifact_id": 9723652212,
            "candidate_checksums_sha256": (
                "561d641faa7a20e7245627a8846c45388f48620ed12fa35f7b5636af6adbbdd3"),
            "evidence_sha256": (
                "3229dc376792e3ff2485f2ad0b7a67fd4134eba93d47be110137eabd98c3f58e"),
            "evidence_reference": (
                "https://github.com/tdhoward/TartLab/blob/"
                "f64b18cd5c1d4728b1067ebbe0f8ee8945fd13a7/tests/evidence/"
                "legacy-v0.15-qualification.json"),
            "promotion_run_id": 33283700400,
            "published_at_utc": "2026-08-30T00:37:04Z",
            "release_url": (
                "https://github.com/tdhoward/TartLab/releases/tag/v0.15"),
            "release_asset_count": 20,
            "promotion_attestation_sha256": (
                "a8935e592bc5a3f48a88d60fa43ad943ed949ec963f4eb6470814bcde0a22b15"),
            "release_attestation_sha256": (
                "2bacc82a982f8a8d0b4e8fb517adbaadaaf48d224b9acc1db84f15b8a66e60d9"),
        })
