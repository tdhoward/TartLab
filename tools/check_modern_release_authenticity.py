...
def validate_workflow(policy: dict[str, Any], workflow_path: Path,
    ...
    required = (
        ...
        "tools/modern_release_matrix.py",
        "tools/check_modern_qualification.py",
        "tools/modern_release_baseline.py prepare",
        "tools/modern_release_baseline.py assemble",
    ...
    qualification_required = (
        ...
        "tools/modern_release_baseline.py prepare",
        "tools/modern_release_baseline.py assemble",
        "tools/modern_release_baseline.py report",
        "tools/modern_release_baseline.py template",
        "tests.test_modern_qualification",
        f"uses: actions/attest@{policy['action']['commit']}",
